  ...
  >
    ...
    <form class="form file-form" onkeydown="return event.key != 'Enter';">
      ...
      <div class="flex justify-between">
        <button class="button cancel-button mr-8" @click="close">Cancel</button>
        <button class="button submit-button ml-8" @click="submitForm">
          Share
        </button>
      </div>
    </form>
...
<style scoped>
.form-container {
  @apply fixed z-[101] flex items-center justify-center w-full inset-0 backdrop-blur;
}
.form {
  width: 90%;
